...
if alive
{
    ...
    || Player.actionCurrent == PlayerActionSwing || Player.actionCurrent == PlayerActionQTEInit || Player.actionCurrent == PlayerActionHomingDash || Player.actionCurrent == PlayerActionHomingAttack
